...
#		#3. Solution Matrix i.e., Matrix x (or return "SINGULAR" as string/array if that's the case)
##Generates matrix
def genQ19_A(n):
	a = np.zeros([n,n])
	for i in range(n):
...
#	#The program should return "divided difference table" and "degree of the polynomial" respectively.
#	#Hint: Look at page 113 of the book to learn how to find the degree of a polynomial from the divided difference table.
...
#print(evalPoly(Q13_coef, Q13_xData, Q_13xData))
#print("---------------------------------")
